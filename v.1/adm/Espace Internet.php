...
<body>
    ...
    <div class="login-container">
        ...
        <form method="post" action="">
            ...
            <button type="submit" class="criee_un_compte-button"><a href="enregistrement.php"
...
if (isset($_POST["submit"])) {
    ...
    $sql = "SELECT * FROM accounts_adm WHERE username='$username' AND password='$password'";
