...
?>
    ...
    <div class="login-container">
        <h1 class="login-heading">Changer de mot de passe</h1>
        <hr>
        <p> Votre mot de passe doit contenir au moins 6 caractères ainsi qu’une <br>combinaison de chiffres, de lettres
            et de caractères spéciaux ( !$@%).</p>

        <form method="post">
            <div style="position: relative">
                <input type="password" class="login-input" name="currentPassword" id="currentPassword"
                    placeholder="Mot de passe actuel" required />
                <i class="fas fa-eye eye-icon" onclick="togglePasswordVisibility('currentPassword')"></i>
            </div>
            <div style="position: relative">
                <input type="password" class="login-input" name="newPassword" id="newPassword"
